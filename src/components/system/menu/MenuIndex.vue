    ...
    <div>
        ...
        <div class="container">
                ...
                <el-row>
                    <el-col span="7">
                        <el-form-item label="菜单名称：" prop="name">
                            <el-input v-model="query.name" size="small" class="handle-input mr10"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col span="7">
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable"
                ...
                <el-table-column prop="parentName" label="上级菜单名称" width="150"></el-table-column>
                <el-table-column prop="name" label="菜单名称" width="150"></el-table-column>
                <el-table-column prop="routePath" label="路由路径" width="120"></el-table-column>
                <el-table-column prop="componentPath" label="页面路径" min-width="180"></el-table-column>
                <el-table-column prop="iconClass" label="菜单图标" width="160"></el-table-column>
                ...
                <el-table-column prop="isRequireAuth" label="是否认证" width="100">
                    <template slot-scope="scope">
                        <span v-if="scope.row.isRequireAuth==='0'">否</span>
                        <span v-else>是</span>
                    </template>
                </el-table-column>
        ...
        <div v-if="visible">
            <el-dialog ref="dialog" :title="title" :visible.sync="visible" width="60%"
                ...
                <v-Form :menuId="query.id" :action="action"></v-Form>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getTableData() {
                let _this = this;
                this.$api.getQs("/system/menu/getPageList", this.query)
                    .then(res => {
            ...
            deleteBatch() {
                let _this = this;
                this.$api.deleteQs("/system/menu/delete", {ids: this.listIds})
                    .then(res => {
                        if (res.data.code === 200) {
            ...
            isEnabled() {
                let _this = this;
                this.$api.postQs("/system/menu/update", this.entity)
                    .then(res => {
                        if (res.data.code === 200) {
                            _this.$api.authentication(_this.getTableData);
                            _this.entity = {};
