    ...
    <div>
        ...
        <div class="container">
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable"
                ...
                <el-table-column prop="name" label="接口权限名称" width="180"></el-table-column>
                <el-table-column prop="code" label="接口权限编码" width="300"></el-table-column>
        ...
        <div v-if="visible">
            <el-dialog ref="dialog" :title="title" :visible.sync="visible" width="60%"
                ...
                <v-Form :pId="query.id" :action="action"></v-Form>
...
<script>
    import vForm from './PermissionForm';
    ...
    export default {
        ...
        methods: {
            ...
            deleteBatch() {
                let _this = this;
                this.$api.deleteQs("/system/permission/delete", {ids: this.listIds})
                    .then(res => {
                        if (res.data.code === 200) {
            ...
            isEnabled() {
                let _this = this;
                this.$api.postQs("/system/permission/update", this.entity)
                    .then(res => {
                        if (res.data.code === 200) {
                            _this.$api.authentication(_this.getTableData);
                            _this.entity = {};
